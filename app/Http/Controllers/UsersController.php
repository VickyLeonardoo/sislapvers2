...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return \redirect(route('login'))->with('message','Kamu Berhasil Mendaftar,Silahkan Verifikasi Email Kamu');
    }
    ...
    public function VerifyEmail($token){
        ...
        if(isset($verifiedUser)){
            ...
            if(!$pelapor->email_verified_at){
                ...
                return redirect()->back()->with('berhasil','Your Email Hasl Already been verified');
            }
        }
        else{
