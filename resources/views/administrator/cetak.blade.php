    ...
    <div class="card card-info">
      ...
      <!-- form start -->
        ...
        <div class="card-body">
          ...
          <a href="#" onclick="this.href='/cetak/laporan/tgl/'+document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value " target="_blank" class="btn btn-info">Cetak</a>
    </div>
</div>  
@endsection